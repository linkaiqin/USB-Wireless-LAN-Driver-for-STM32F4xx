...
const DOT11_REGULATORY_INFORMATION USARegulatoryInfo[] = 
{
...
const DOT11_REGULATORY_INFORMATION EuropeRegulatoryInfo[] = 
{
/*  "regulatory class"  "number of channels"  "Max Tx Pwr"  "channel list" */
...
const DOT11_REGULATORY_INFORMATION JapanRegulatoryInfo[] = 
{
/*  "regulatory class"  "number of channels"  "Max Tx Pwr"  "channel list" */
    {0,                 {0,                   0,           {0}}}, /* Invalid entry*/
    {1,                 {4,                   22,           {34, 38, 42, 46}}}, 

	...
	IN	PRTMP_ADAPTER pAd)
{
		...
		)
	{
		...
		{		
			...
			{
                printk("!!!!!!!!!!!!!!!!!!!!fRTUSB_BULK_OUT_DATA_NORMAL_2");//add by LKQ
		...
		if (RTUSB_TEST_BULK_FLAG(pAd, fRTUSB_BULK_OUT_DATA_NORMAL_3))
		{
			...
			{
                printk("!!!!!!!!!!!!!!!!!!!!fRTUSB_BULK_OUT_DATA_NORMAL_3");//add by LKQ
                #ifndef HIGHLY_OPTIMIZE
		...
		if (RTUSB_TEST_BULK_FLAG(pAd, fRTUSB_BULK_OUT_DATA_NORMAL_4))
		{
			...
			{
                printk("!!!!!!!!!!!!!!!!!!!!fRTUSB_BULK_OUT_DATA_NORMAL_4");//add by LKQ
                #ifndef HIGHLY_OPTIMIZE
		...
		{
            printk("!!!!!!!!!!!!!!!!!!!!fRTUSB_BULK_OUT_DATA_NULL_HCCA");
            #ifndef HIGHLY_OPTIMIZE
			if (!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_BSS_SCAN_IN_PROGRESS))
			{

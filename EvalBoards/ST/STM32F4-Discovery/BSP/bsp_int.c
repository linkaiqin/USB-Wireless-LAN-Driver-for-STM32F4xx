...
static  CPU_FNCT_PTR  BSP_IntVectTbl[BSP_INT_SRC_NBR];
static  void        *BSP_IntParaTbl[BSP_INT_SRC_NBR];
...
static  void  BSP_IntHandlerDummy(void *p_arg);
...
void  BSP_IntInit (void)
{
    ...
    for (int_id = 0; int_id < BSP_INT_SRC_NBR; int_id++) {
        BSP_IntVectSetEx(int_id, BSP_IntHandlerDummy, NULL);
    }
}
...
void  BSP_IntHandlerDMA1_STREAM7       (void)  { BSP_IntHandler(BSP_INT_ID_DMA1_CH7);        }

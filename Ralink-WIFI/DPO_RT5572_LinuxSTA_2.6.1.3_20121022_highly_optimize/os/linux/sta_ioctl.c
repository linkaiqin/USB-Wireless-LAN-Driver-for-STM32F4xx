...
const struct iw_priv_args privtab[] = {
{ RTPRIV_IOCTL_SET, 
			 ...
			 void *w, char *extra)
{
	...
	NdisZeroMemory(this_char, strlen(extra) + 1);
	NdisMoveMemory(this_char, extra, strlen(extra));

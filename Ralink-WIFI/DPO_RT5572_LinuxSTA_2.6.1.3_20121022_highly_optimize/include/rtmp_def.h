...
#ifdef RTMP_MAC_USB
#define TX_RING_SIZE            2//8	/* 1 */
#define PRIO_RING_SIZE          2//8
#define MGMT_RING_SIZE       	1//32	/* PRIO_RING_SIZE */
#ifdef INF_AMAZON_SE
#define RX_RING_SIZE            1
#else
#define RX_RING_SIZE            1//8
#endif /* INF_AMAZON_SE */
...
#ifdef MEMORY_OPTIMIZATION
#define MAX_LEN_OF_BSS_TABLE             1// 1
#define MAX_REORDERING_MPDU_NUM			 4//256
#else
#define MAX_LEN_OF_BSS_TABLE             5//64
#define MAX_REORDERING_MPDU_NUM			 8//512
#endif

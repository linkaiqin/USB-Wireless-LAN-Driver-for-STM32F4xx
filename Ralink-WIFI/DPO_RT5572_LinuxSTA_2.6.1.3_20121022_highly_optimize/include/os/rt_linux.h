...
// #include <asm/types.h>
#include "unaligned.h"	/* for get_unaligned() */
...
typedef struct semaphore	OS_SEMA;
...
{	\
	...
	{\
        OSTimeDlyHMSM(0, 0, 0, _time,OS_OPT_TIME_HMSM_NON_STRICT, &err);\
	}\
}
...
#else
#define BULKAGGRE_SIZE				7//60 /* 100 */
#endif /* INF_AMAZON_SE */
